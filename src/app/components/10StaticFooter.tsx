    ...
    return (
        <footer className="bg-black text-white py-8 px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    <h3 className="text-xl sm:text-base font-semibold mb-4">FIND A STORE</h3>
                ...
                {/* Column 2: Get Help */}
                <div>
                    <h3 className="text-xl sm:text-base font-semibold mb-4">GET HELP</h3>
                    <ul className="space-y-2 text-sm">
                ...
                {/* Column 3: About Nike */}
                <div>
                    <h3 className="text-lg sm:text-base font-semibold mb-4">ABOUT NIKE</h3>
                    <ul className="space-y-2 text-sm">
            ...
            {/* Footer Information */}
           <div className="mt-8 flex flex-wrap justify-between items-center text-xs sm:text-sm text-gray-400">
